defmodule Mix.Tasks.Jsonapi.Gen.Resource do
  use Mix.Task
  ...
  Generates a Phoenix resource.
      ...
      mix jsonapi.gen.resource User users name:string age:integer
  ...
  def run(args) do
    ...
    Mix.Phoenix.copy_from paths(), "priv/templates/jsonapi.gen.resource", "", binding, files
  ...
  defp raise_with_help do
    Mix.raise """
    mix jsonapi.gen.resource expects both singular and plural names
    of the generated resource followed by any number of attributes:

        mix jsonapi.gen.resource User users name:string
    """
  end
