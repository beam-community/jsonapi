...
defmodule JSONAPI.View do
  ...
  @callback url_for_related_resource(term(), String.t(), Conn.t() | nil) :: String.t()
  ...
  defmacro __using__(opts \\ []) do
    ...
    quote do
      ...
      @impl View
      def url_for_related_resource(data, rel_type, conn),
        do: View.url_for_related_resource(__MODULE__, data, rel_type, conn)
  ...
  @spec url_for_related_resource(t(), data(), String.t(), Conn.t() | nil) :: String.t()
  def url_for_related_resource(view, data, relationship_key, conn) do
