defmodule JSONAPI.View do
  ...
  is an example of a basic view. You can now call `UserView.show(user, conn)` and it will
  ...
  defmacro __using__(_opts) do
    quote do
      import JSONAPI, only: [show: 3, index: 4]
      ...
      def show(model, conn), do: show(__MODULE__, model, conn)
